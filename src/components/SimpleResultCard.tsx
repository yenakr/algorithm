...
export default function SimpleResultCard({
  ...
  return (
    <div className="grid grid-cols-1 gap-6 text-left w-full max-w-4xl mx-auto">
      {/* 1. 추천 돌봄로봇 */}
      <div className="bg-white border-2 border-indigo-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-3">
        <h4 className="text-sm font-black text-indigo-800 flex items-center gap-1.5 uppercase tracking-wider">
          <Trophy className="w-5 h-5 text-indigo-650 shrink-0" />
          추천 돌봄로봇
        </h4>
        <p className="text-2xl font-black text-indigo-950 leading-snug">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-3">
        <h4 className="text-sm font-black text-slate-700 flex items-center gap-1.5 uppercase tracking-wider">
          <Lightbulb className="w-5 h-5 text-amber-500 shrink-0" />
          왜 추천하나요?
        </h4>
        <p className="text-base sm:text-lg text-slate-600 leading-relaxed font-bold">
      ...
      {precautions && precautions.length > 0 && (
        <div className="bg-orange-50/50 border-2 border-orange-200 rounded-3xl p-6 sm:p-8 space-y-4">
          <h4 className="text-sm font-black text-orange-950 flex items-center gap-1.5 uppercase tracking-wider">
            <AlertTriangle className="w-5 h-5 text-orange-600 shrink-0" />
            조심하세요 (주의사항)
          </h4>
          <ul className="space-y-2 text-base text-slate-650 font-bold list-disc pl-5 leading-relaxed">
