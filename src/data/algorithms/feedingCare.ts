...
export const feedingCareAlgorithm = {
  ...
  results: {
    'F-A': {
      ...
      description: '가벼운 정도의 어려움이 있다면, 특수식사도구 이용 및 수동형 팔 지지대 이용',
      simpleDescription: '가벼운 정도의 어려움이 있다면, 특수식사도구 이용 및 수동형 팔 지지대 이용',
    ...
    'F-C': {
      ...
      description: '팔의 근력에 따라 부분 식사보조기기 이용 또는 수동/반자동 식사돌봄로봇 이용',
      simpleDescription: '팔의 근력에 따라 부분 식사보조기기 이용 또는 수동/반자동 식사돌봄로봇 이용',
    ...
    'F-D': {
      ...
      description: '구강 섭취 불가능 시 의료진 지시에 따르고 비경구영양 고려',
      simpleDescription: '구강 섭취 불가능 시 의료진 지시에 따르고 비경구영양 고려',
