...
export const feedingCareAlgorithm = {
  ...
  results: {
    'F-A': {
      id: 'F-A',
      title: '가벼운 정도의 어려움이 있다면, • 특수식사도구 이용 (코 부위가 절린 컵, 경사 접시 등) • 수동형 팔 지지대 이용',
      simpleTitle: '가벼운 정도의 어려움이 있다면, • 특수식사도구 이용 (코 부위가 절린 컵, 경사 접시 등) • 수동형 팔 지지대 이용',
      description: '가벼운 정도의 어려움이 있다면, • 특수식사도구 이용 (코 부위가 절린 컵, 경사 접시 등) • 수동형 팔 지지대 이용',
      simpleDescription: '가벼운 정도의 어려움이 있다면, • 특수식사도구 이용 (코 부위가 절린 컵, 경사 접시 등) • 수동형 팔 지지대 이용',
    ...
    'F-C': {
      id: 'F-C',
      title: '부분 식사보조기기 이용 (예: 스프링 팔 지지대) / 수동/반자동 식사돌봄로봇 이용',
      simpleTitle: '부분 식사보조기기 이용 (예: 스프링 팔 지지대) / 수동/반자동 식사돌봄로봇 이용',
      description: '부분 식사보조기기 이용 (예: 스프링 팔 지지대) / 수동/반자동 식사돌봄로봇 이용',
      simpleDescription: '부분 식사보조기기 이용 (예: 스프링 팔 지지대) / 수동/반자동 식사돌봄로봇 이용',
    ...
    'F-D': {
      id: 'F-D',
      title: '구강 섭취 불가능 시, • 의료진의 지시에 따름. • 건강 영양 또는 완전 비경구영양 / 식사 시 찾은 사례와 기침 시, • 구강 섭취(물 포함) 중단 • 의료진과 상의',
      simpleTitle: '구강 섭취 불가능 시, • 의료진의 지시에 따름. • 건강 영양 또는 완전 비경구영양 / 식사 시 찾은 사례와 기침 시, • 구강 섭취(물 포함) 중단 • 의료진과 상의',
      description: '구강 섭취 불가능 시, • 의료진의 지시에 따름. • 건강 영양 또는 완전 비경구영양 / 식사 시 찾은 사례와 기침 시, • 구강 섭취(물 포함) 중단 • 의료진과 상의',
      simpleDescription: '구강 섭취 불가능 시, • 의료진의 지시에 따름. • 건강 영양 또는 완전 비경구영양 / 식사 시 찾은 사례와 기침 시, • 구강 섭취(물 포함) 중단 • 의료진과 상의',
