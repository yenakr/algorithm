...
export const transferCareAlgorithm = {
  ...
  questions: {
    ...
    q2: {
      id: 'q2',
      title: 'Q2. 하지 근력 및 체중 지지 여부',
      description: '다리 힘으로 체중을 지탱할 수 있나요?',
      type: 'single',
      options: [
        { id: 'q2_yes', text: '가능하다: 혼자서 서거나 보행이 가능하고 약간의 도움으로 서기가 가능하다', value: 'yes' },
        { id: 'q2_no', text: '어렵다: 다리를 들어올릴 수는 있으나 체중 지지가 어렵고 다리 움직임이 거의 없다', value: 'no' },
      ],
      nextQuestionId: (answers: Record<string, any>) => {
  ...
  results: {
    ...
    'T-E': {
      ...
      reason: '자리이동에 어려움이 크고 체중 지지가 힘든 상황에서 천장 공사가 가능하고 사용 편의성을 최우선으로 선호하셨습니다.'
    },
    'T-F': {
      id: 'T-F',
    ...
    'T-G': {
      ...
      reason: '체중 지지가 어려워 리프트가 필수적이나 천장과 벽면 등 건물 구조물의 고정 설치가 불가능하고 바닥 공간 이동이 편리한 환경입니다.'
    },
    'T-H': {
      id: 'T-H',
      title: 'T-H. 이동식 겐트리 리프트 고려',
