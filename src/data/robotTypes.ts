  ...
  transfer: [
    {
      id: "ceiling-hoist",
      name: "천장형 리프트",
      oneLine: "천장에 설치된 트랙을 따라 돌봄받는자를 들어 올리고 이동시키는 고정형 이승 보조 장치",
      situations: [
    ...
    },
    {
      id: "mobile-lift",
      name: "이동식 리프트",
      oneLine: "바퀴가 달린 이동형 장비로, 침대에서 의자나 화장실 등으로 이동하기 어려운 돌봄받는자를 옮기는 데 사용돼요",
      situations: [
    ...
    },
    {
      ...
      oneLine: "전동 시스템과 지지 장치를 이용해 돌봄받는자의 체중을 지지하고, 들어올리기나 일어섬을 돕는 이승돌봄 장비",
      situations: [
  ...
  toileting: [
    {
      ...
      name: "배설물 자동 처리 기기",
      oneLine: "거동이 불편한 대상자의 대소변을 감지하고, 처리·세정·건조 과정을 자동으로 보조하는 배설 케어 로봇",
      situations: [
        "침상에서 생활하는 시간이 긴 경우",
    ...
    },
    {
      ...
      oneLine: "센서를 통해 배뇨와 배변 정보를 감지하고, 돌봄제공자에게 실시간으로 전달하는 모니터링 기기",
      situations: [
    ...
    },
    {
      ...
      name: "배설 예측 기기",
      oneLine: "방광 내 소변량을 모니터링하여 화장실에 갈 시점을 미리 알려주는 배설 예측 기기",
      situations: [
  ...
  feeding: [
    {
      ...
      name: "전자동 식사돌봄로봇",
      oneLine: "사용자가 원하는 음식을 선택하면 로봇이 음식을 떠서 입 위치로 전달하는 자동 식사 보조 로봇",
      situations: [
    ...
    },
    {
      id: "feeding-manual",
      name: "수동형 식사돌봄로봇",
      oneLine: "사용자의 손 움직임을 보조하여 숟가락을 들어 올리고 음식을 먹는 과정을 돕는 수동형 식사 보조 장치",
      situations: [
    ...
    },
    {
      ...
      name: "반자동 팔 지지대",
      oneLine: "팔을 전동 또는 반자동으로 지지하여 식사, 물 마시기, 물건 잡기 등의 동작을 돕는 장치",
      situations: [
    ...
    },
    {
      ...
      name: "수동형 팔 지지대",
      oneLine: "팔과 손목을 지지해 음식을 입으로 가져가는 동작을 안정적으로 수행할 수 있도록 돕는 수동형 지지 장치",
      situations: [
